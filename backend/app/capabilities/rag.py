...
from app.domain.memory import search_memories
from app.infra.kb_rerank import rerank_hits, rerank_info
from app.infra.kb_search import rrf_fuse
from app.infra.local_kb import get_store
...
def _guess_names(text: str) -> list[str]:
    ...
    try:
        ...
        known = []
        for a in (read_json("analyses.json", {}) or {}).values():
